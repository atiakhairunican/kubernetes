...
export KOPS_STATE_STORE=s3://k8s-store
export NAME=teras-rindang.com
...
```bash
kops create cluster --cloud=aws --zones=us-east-1a --name=$NAME --node-size=t2.small --master-size=t2.small --dns-zone=teras-rindang.com --dns private
